...
:usage
echo.
echo Usage: "setenv <directory> [fre|chk] [64|x64] [hal] [WLH|WXP|WNET|W2K] [bscmake]"
echo.
...
echo   Example:  setenv d:\ddk fre WLH    set free environment for Windows Vista (default)
