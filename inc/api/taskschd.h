...
unsigned char * __RPC_USER  VARIANT_UserMarshal(  __RPC__in unsigned long *, unsigned char *, __RPC__in VARIANT * );
unsigned char * __RPC_USER  VARIANT_UserUnmarshal(__RPC__in unsigned long *, unsigned char *, __RPC__out VARIANT * );
...
unsigned char * __RPC_USER  VARIANT_UserMarshal64(  __RPC__in unsigned long *, unsigned char *, __RPC__in VARIANT * );
unsigned char * __RPC_USER  VARIANT_UserUnmarshal64(__RPC__in unsigned long *, unsigned char *, __RPC__out VARIANT * );
