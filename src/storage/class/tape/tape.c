...
static VOID TapeClassQuerySetAutoRunValue(PUNICODE_STRING unicodeRegistryPath, ULONG AutoRun)
{
    OBJECT_ATTRIBUTES   objectAttributes = {0};
    NTSTATUS            status;
    HANDLE              tapeKey;
    UNICODE_STRING      unicodeKeyValue = {0};
    PWCHAR              ValueName = L"AutoRun";
    RTL_QUERY_REGISTRY_TABLE parameters[2] = {0};
    ULONG mcnRegistryValue;
...

{
    ...
    TapeClassQuerySetAutoRunValue(registryPath,0);
