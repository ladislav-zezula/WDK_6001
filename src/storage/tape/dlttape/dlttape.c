...

{
    ...
    if (TapeClassCompareMemory(InquiryData->VendorId,"QUANTUM",7) == 7) {
        ...
        if (TapeClassCompareMemory(InquiryData->ProductId,"DLT VS160",9) == 9) {
            return QUANTUM_8000;
        }
        ...
        if (TapeClassCompareMemory(InquiryData->ProductId,"SDLT600",7) == 7) {
            return QUANTUM_8000;
        }

        if (TapeClassCompareMemory(InquiryData->ProductId,"DLT-V4",6) == 6) {
            return QUANTUM_8000;
        }
