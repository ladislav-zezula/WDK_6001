...
DRIVER_DISPATCH SerialCreateOpen;
...
DRIVER_DISPATCH SerialIoControl;
...
DRIVER_DISPATCH SerialQueryInformationFile;

__drv_dispatchType(IRP_MJ_SET_INFORMATION)
DRIVER_DISPATCH SerialSetInformationFile;
...
DRIVER_DISPATCH SerialPnpDispatch;

__drv_dispatchType(IRP_MJ_POWER)
DRIVER_DISPATCH SerialPowerDispatch;
...
DRIVER_DISPATCH SerialSystemControlDispatch;
...
DRIVER_DISPATCH SerialInternalIoControl;
