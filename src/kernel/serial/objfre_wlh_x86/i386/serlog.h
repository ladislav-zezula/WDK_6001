...
//
// MessageId: SERIAL_NO_TRANSLATE_PORT
//
// MessageText:
//
// Could not translate the user reported I/O port for %2.
//
#define SERIAL_NO_TRANSLATE_PORT         ((NTSTATUS)0xC0060025L)

//
// MessageId: SERIAL_NO_GET_INTERRUPT
//
// MessageText:
//
// Could not get the user reported interrupt for %2 from the HAL.
//
#define SERIAL_NO_GET_INTERRUPT          ((NTSTATUS)0xC0060026L)

//
// MessageId: SERIAL_NO_TRANSLATE_ISR
//
// MessageText:
//
// Could not translate the user reported Interrupt Status Register for %2.
//
#define SERIAL_NO_TRANSLATE_ISR          ((NTSTATUS)0xC0060027L)

//
// MessageId: SERIAL_NO_DEVICE_REPORT
//
// MessageText:
//
// Could not report the discovered legacy device %2 to the IO subsystem.
//
#define SERIAL_NO_DEVICE_REPORT          ((NTSTATUS)0xC0060028L)

//
// MessageId: SERIAL_REGISTRY_WRITE_FAILED
//
// MessageText:
//
// Error writing to the registry.
//
#define SERIAL_REGISTRY_WRITE_FAILED     ((NTSTATUS)0xC0060029L)

//
// MessageId: SERIAL_MOUSE_CONFLICT_IRQ
//
// MessageText:
//
// There is a serial mouse using the same interrupt as %2.  Therefore, %2 will not be started.
//
#define SERIAL_MOUSE_CONFLICT_IRQ        ((NTSTATUS)0x8006002AL)

//
// MessageId: SERIAL_MOUSE_ON_PORT
//
// MessageText:
//
// There was a serial mouse found on %2.  Therefore, %2 will be assigned to the mouse.
//
#define SERIAL_MOUSE_ON_PORT             ((NTSTATUS)0x8006002BL)

//
// MessageId: SERIAL_NO_DEVICE_REPORT_RES
//
// MessageText:
//
// Could not report device %2 to IO subsystem due to a resource conflict.
//
#define SERIAL_NO_DEVICE_REPORT_RES      ((NTSTATUS)0xC006002CL)

//
// MessageId: SERIAL_HARDWARE_FAILURE
//
// MessageText:
//
// The serial driver detected a hardware failure on device %2 and will disable this device.
//
#define SERIAL_HARDWARE_FAILURE          ((NTSTATUS)0xC006002DL)
