...
//
// MessageId: AGP_FAILED_TLB_FLUSHING_VERIFIFICATION
//
// MessageText:
//
// Chipset failed validation of AGP TLB flushing functionnality; disabling AGP.
//
#define AGP_FAILED_TLB_FLUSHING_VERIFIFICATION ((ULONG)0xC0000000L)

//
// MessageId: AGP_FAILED_CHIPSET_CACHE_FLUSHING_VERIFICATION
//
// MessageText:
//
// Chipset failed validation of chipset cache (posted write buffer) flushing functionnality; disabling AGP.
//
#define AGP_FAILED_CHIPSET_CACHE_FLUSHING_VERIFICATION ((ULONG)0x00000001L)
