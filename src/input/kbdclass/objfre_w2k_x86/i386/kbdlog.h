...
//
// MessageId: KBDCLASS_COULD_NOT_CREATE_DEVICE
//
// MessageText:
//
// The driver could not create the required device object.
//
#define KBDCLASS_COULD_NOT_CREATE_DEVICE ((NTSTATUS)0xC005000DL)

//
// MessageId: KBDCLASS_NO_RESOURCES_FOR_WAITWAKE
//
// MessageText:
//
// The driver could not obtain resources required to create a propper WaitWake IRP.
//
#define KBDCLASS_NO_RESOURCES_FOR_WAITWAKE ((NTSTATUS)0x8005000EL)

//
// MessageId: KBDCLASS_ATTACH_DEVICE_FAILED
//
// MessageText:
//
// Could not attach to the PnP device stack.
//
#define KBDCLASS_ATTACH_DEVICE_FAILED    ((NTSTATUS)0xC005000FL)
