...
//
// MessageId: MOUCLASS_COULD_NOT_CREATE_DEVICE
//
// MessageText:
//
// The driver could not create the required device object.
//
#define MOUCLASS_COULD_NOT_CREATE_DEVICE ((NTSTATUS)0xC005000DL)

//
// MessageId: MOUCLASS_NO_RESOURCES_FOR_WAITWAKE
//
// MessageText:
//
// The driver could not obtain resources required to create a propper WaitWake IRP.
//
#define MOUCLASS_NO_RESOURCES_FOR_WAITWAKE ((NTSTATUS)0x8005000EL)

//
// MessageId: MOUCLASS_ATTACH_DEVICE_FAILED
//
// MessageText:
//
// Could not attach to the PnP device stack.
//
#define MOUCLASS_ATTACH_DEVICE_FAILED    ((NTSTATUS)0xC005000FL)
