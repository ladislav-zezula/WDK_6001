...
CDefaultASCIIXlator::KBD_KEYCODESEQ1 CDefaultASCIIXlator::m_KeyCodeLen1SubTable[127] = 
{
    ...
    UNASSIGNED1,                    // Key location 57 (KEY_R_SHIFT)
    UNASSIGNED1,                    // Key location 58 (KEY_L_CTRL)
    UNASSIGNED1,                    // Key location 59 (KEY_L_WIN)
    UNASSIGNED1,                    // Key location 60 (KEY_L_ALT)
    ASSIGN_CODE1(KEY_SPACE),        // Key location 61 (KEY_SPACE)
    UNASSIGNED1,                    // Key location 62 (KEY_R_ALT)
    UNASSIGNED1,                    // Key location 63 (KEY_R_WIN)
    UNASSIGNED1,                    // Key location 64 (KEY_R_CTRL)
...
CDefaultASCIIXlator::KBD_KEYCODESEQ3 CDefaultASCIIXlator::m_KeyCodeLen3SubTable[127] = 
{
    ...
    UNASSIGNED3,                    // Key location 43 (KEY_ENTER)
    UNASSIGNED3,                    // Key location 44 (KEY_L_SHIFT)
    ...
    UNASSIGNED3,                    // Key location 57 (KEY_R_SHIFT)
    UNASSIGNED3,                    // Key location 58 (KEY_L_CTRL)
    UNASSIGNED3,                    // Key location 59 (KEY_L_WIN)
    UNASSIGNED3,                    // Key location 60 (KEY_L_ALT)
    UNASSIGNED3,                    // Key location 61 (KEY_SPACE)
    UNASSIGNED3,                    // Key location 62 (KEY_R_ALT)
    UNASSIGNED3,                    // Key location 63 (KEY_R_WIN)
    UNASSIGNED3,                    // Key location 64 (KEY_R_CTRL)
